...
# Used to determine whether to use the secure version of cookies
CSRF_TRUSTED_ORIGINS = ["https://the-wine-bar-5c52e3b945e9.herokuapp.com"]
...
WSGI_APPLICATION = "win_bar.wsgi.application"
...
# Add to settings.py for Heroku deployment and extra security
if not DEBUG:
